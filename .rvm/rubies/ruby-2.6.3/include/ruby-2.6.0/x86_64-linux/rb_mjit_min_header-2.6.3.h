...
extern _Float128 nextafterf128 (_Float128 __x, _Float128 __y) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__const__)); extern _Float128 __nextafterf128 (_Float128 __x, _Float128 __y) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__const__));
...
#undef __MATHDECL
#undef __MATHCALL
#define __MATH_TG(TG_ARG,FUNC,ARGS) _Generic ((TG_ARG), float: FUNC ## f ARGS, default: FUNC ARGS, long double: FUNC ## l ARGS, _Float128: FUNC ## f128 ARGS)
#define FP_NAN 0
